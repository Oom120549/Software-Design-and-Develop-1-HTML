    ...
    <form action="/register" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="radio" id="female" name="gender" value="female">
                <label for="female">เพศ</label>
                <input type="radio" id="female" name="gender" value="female">
                <label for="null">เพศทางเลือก</label>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <label for="game">อุปกรณ์อิเล็กทรอนิกส์</label>
            </div>
        </fieldset>
...
![image](https://github.com/user-attachments/assets/72cda6c6-ca9a-49fd-8248-bee150605cb4)
